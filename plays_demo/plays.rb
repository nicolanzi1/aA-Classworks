...
class Play
  ...
  def self.find_by_title(title)
    ...
    Play.new(play.first) # This is because play is stored in an array!
  end
  ...
  def insert
    ...
    # We use (?, ?, ?) to sanitize our code and prevent SQL injection attacks

    # heredoc (<<-SQL => This is a heredoc to write a SQL query
  end
